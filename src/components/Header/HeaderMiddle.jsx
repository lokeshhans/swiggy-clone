  ...
  return (
    <>
      <div className="flex items-center justify-center h-40 gap-2.5">
        <img
          className=" h-1/3 min-h-28 md:h-1/3 lg:h-2/3 xl:h-3/4 absolute left-0 top-10"
          src="https://media-assets.swiggy.com/swiggy/image/upload/fl_lossy,f_auto,q_auto/portal/testing/seo-home/Veggies_new.png"
          alt=""
        />
        <div className="input w-1/4 flex rounded-xl py-6 bg-white">
        ...
        <div className="input w-1/3 rounded-xl py-6 bg-white">
        ...
        <img
          className="h-1/3 min-h-28 md:h-1/3 lg:h-2/3 xl:h-3/4 top-10 absolute right-0"
